...
del /q C:\Users\ezer\aiterm-proof.txt 2>nul
set AITERM_DEBUG=1
...
aiterm.exe send --surface surface:1 "echo PROOF_VIA_STDIN > C:\Users\ezer\aiterm-proof.txt" >> "%LOG%" 2>&1
aiterm.exe send-key --surface surface:1 Return >> "%LOG%" 2>&1
timeout /t 5 /nobreak >nul
if exist C:\Users\ezer\aiterm-proof.txt (
  echo PROOF FILE EXISTS: >> "%LOG%"
  type C:\Users\ezer\aiterm-proof.txt >> "%LOG%"
) else (
