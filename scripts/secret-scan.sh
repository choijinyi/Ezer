...
# 스캐너 자신과 형제 스캐너(scan-pack-secrets.sh)는 제외 — 둘 다 자기 패턴/정책 정의에 /Users/EZERagent·
...
for f in "${files[@]}"; do
  ...
  grep -nE '\.claude-(ysfuture|cysinsight|EZERagentfuturist)|/Users/EZERagent' "$f" 2>/dev/null \
