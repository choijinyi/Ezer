...
_pack = os.environ.get('EZER_PACK_DIR') or os.path.expanduser('~/.ezer/pack')
DEFAULT_PREFLIGHT = f'python3 {_pack}/bin/ezer_preflight.py'
...
def main(argv=None):
    ...
    ap.add_argument('--preflight-cmd', default=DEFAULT_PREFLIGHT,
                    help='preflight 실행 명령(기본: ezer_preflight.py)')
