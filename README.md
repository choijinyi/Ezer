...
히브리어로 "도움·돕는 자"를 뜻하는 말입니다.
이 AI는 사람을 대신하는 존재가 아니라, 사람이 하는 일을 곁에서 돕는 조력자라는 의미로 에제르라고 이름을 붙였습니다.
...
누구나 자기 일에 필요한 스킬을 골라 쓰는 범용 AI Agent를 목표로, 글쓰기·조사·통계·영상·개발·생활 행정까지 일상 업무 스킬을 중심으로 제작되었습니다.
