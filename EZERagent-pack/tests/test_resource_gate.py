#!/usr/bin/env python3
"""EZERagent_resource_gate 단위 테스트 — stdlib unittest만 (신규 의존성 0).
...
import EZERagent_resource_gate as G  # noqa: E402
...
class TestCodexDoubleCountExclusion(unittest.TestCase):
    ...
    def test_self_and_nonnode_not_counted(self):
        lines = [
            "  201 python3 bin/EZERagent_resource_gate.py check",  # 자기 자신 — 제외
