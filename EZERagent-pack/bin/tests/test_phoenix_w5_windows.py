...
이중스폰 차단 실거동·CI 실 EZERagentd.exe 부활은 **Windows 러너에서만 검증 가능**(설계 D4/E1) — 이 파일은 mac/Linux
...
실행: python3 EZERagent-pack/bin/tests/test_phoenix_w5_windows.py  (0=전건 PASS)
"""
...
def main():
    ...
    sock = os.path.join(td, "state", "EZERagent.sock")
