...
실행: python3 EZERagent-pack/bin/tests/test_phoenix_w2_tombstone.py  (0=전건 PASS)
"""
...
m.EZERAGENT = "/nonexistent-EZERagent"
...
def main():
    ...
    m.observe_and_persist_roster(os.path.join(sd, "EZERagent.sock"))
