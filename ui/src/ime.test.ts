...
describe("Profile D — EZERagent-neo(신규 실기기 버그): xterm _inputEvent insertText 자모 유출(이중 전송)", () => {
  ...
  // 관측된 실기기 트레이스($TMPDIR/EZERagent-ime.log)의 각 FLUSH(onData)는 '다음 음절의 유출 onData'가
